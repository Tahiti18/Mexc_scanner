// MEXC Futures Spike Scanner + Built-in Live Dashboard (SSE) + Tick SSE
...
async function buildUniverse() {
  ...
  try {
    if (FORCE_UNIVERSE_MODE === 'DETAIL') {
      ...
      // Auto: prefer detail; fallbacks as needed
...
// ===== HTTP server (live UI + SSE endpoints) =====
